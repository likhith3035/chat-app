    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-40 p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 text-center">
                <h2 className="text-xl font-semibold mb-4 text-gray-800">Share Room Link</h2>
                <input
                    type="text"
                    value={link}
                    className="w-full p-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-600 mb-4 text-sm"
                    readOnly
                />
                ...
                <button onClick={onClose} className="mt-4 w-full py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                    Close
                </button>
            </div>
        </div>
