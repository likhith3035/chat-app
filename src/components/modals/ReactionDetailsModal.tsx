...
export default function ReactionDetailsModal({ reactions, onClose }: ReactionDetailsModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600/75 dark:bg-black/60 flex items-center justify-center z-50 p-4" onClick={onClose}>
            <div className="bg-white dark:bg-slate-900 border border-transparent dark:border-white/10 rounded-2xl shadow-2xl w-full max-w-xs flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
