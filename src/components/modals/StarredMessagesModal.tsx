...
export default function StarredMessagesModal({ onClose }: StarredMessagesModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600/75 dark:bg-black/80 flex items-center justify-center z-[100] p-4" onClick={onClose}>
            <div className="bg-white dark:bg-slate-900 border border-transparent dark:border-white/10 rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[80vh] overflow-hidden" onClick={e => e.stopPropagation()}>
